...
JLabel broadCastLabel = new JLabel("Broad Cast messages from all online users",JLabel.CENTER);
broadCastLabel.setBackground(Color.BLUE);
center1.add(broadCastLabel,"North");
...
chatWindow.pack();
chatWindow.setTitle("Login Window for Chat");
...
if(temp==loginButton)
{
String uname=JOptionPane.showInputDialog(chatWindow,"Enter Your  user Name: ");
if(uname!=null)
	clientChat(uname); 
}
